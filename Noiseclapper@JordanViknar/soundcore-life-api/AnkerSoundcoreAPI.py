...
#This is based of an old version of the Soundcore API by KillerBOSS2019. I (JordanViknar) only changed a few strings to make the bash script not a massive pain to make.
...
LifeQ30 = {
    ...
    "Small Speakers":       "08ee000000028114001200a0968278645a50502d",
