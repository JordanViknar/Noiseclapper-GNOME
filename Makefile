...
SOURCE_FILES = src/extension.ts src/prefs.ts src/indicator.ts src/utilities.ts
JS_FILES = $(DIST_DIR)/extension.js $(DIST_DIR)/prefs.js $(DIST_DIR)/indicator.js $(DIST_DIR)/utilities.js
